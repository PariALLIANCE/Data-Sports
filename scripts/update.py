...
# Ligues éligibles à l'enrichissement journée
# (toutes les ligues sauf cups et compétitions UEFA/FIFA)
CUPS_AND_INTL = {
    "FIFA_Club_World_Cup",
...
def enrich_journee(matches_list: list, league_key: str) -> list:
    """
    Ajoute journee, saison_offset, saison, saison_terminee
    uniquement sur les matchs qui n'ont pas encore ces champs.
    """
    ...
    # Trier tous les matchs du plus récent au plus ancien
    def sort_key(m):
    ...
    # Attribuer les journées par équipe
    match_journee = {}
    ...
    for m in matches_list:
        ...
        # On n'écrase pas si déjà enrichi
